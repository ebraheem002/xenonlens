...
const MapComponent = () => {
  ...
  const locations = [
    ...
    { name: 'الفا للبصريات', position: [36.38251368635588, 43.18023984110992]},
    { name: 'ماركة للبصريات', position: [36.35643695528986, 43.15961794133438]},
    { name: ' الميثاق للبصريات', position: [36.33018426527866, 43.193362319835295] }
