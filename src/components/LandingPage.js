      ...
      <section id="map" className="myMap">
        <div className="myMap-content">
          ...
          <h2>: تتوفر عدساتنا في المتاجر التالية</h2>
            ...
            <p><strong> الفا للبصريات</strong><br />الموصل - الجانب الايسر - المصارف </p>
            <p><strong> الميثاق للبصريات</strong><br />الموصل - الجانب الايسر - الميثاق </p>
            <p><strong> ماركة للبصريات</strong><br />الموصل - الجانب الايسر - الدركزلية - مقابل سوق النبي يونس </p>
